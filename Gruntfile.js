module.exports = function ( grunt ) {
    ...
    var taskConfig = {
        ...
        karmaSonar: {
            options: {
                instance: {
                    ...
                    /*hostUrl : function() {
                     return grunt.file.readJSON("/home/bamboo/sonardata.json").host;
                     },
                     jdbcUrl : function() {
                     return grunt.file.readJSON("/home/bamboo/sonardata.json").jdbc;
                     },
                     jdbcUsername: function() {
                     return grunt.file.readJSON("/home/bamboo/sonardata.json").user;
                     },
                     jdbcPassword: function() {
                     return grunt.file.readJSON("/home/bamboo/sonardata.json").password;
                     }*/
                }
            },
            sonarqube: {
        ...
        copy: {
            ...
            /**
             * La función rename funciona solo para las fuentes de orion que tienen la sgte estructura:
             * vendor/orion-ui-ionicons/fonts/<fuente>
             */
            build_fonts: {
                files: [
                    {
     ...
     */
    grunt.registerTask( 'default', [ 'build', 'compile', 'zip' ] );

    grunt.registerTask( 'sonar', [ 'build', 'compile', 'zip', 'karmaSonar' ] );
    /**
